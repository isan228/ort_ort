...
const DEFAULT_PLANS = [
  {
    code: 'premium',
    title: 'Premium',
    description: 'Полный доступ ко всем функциям сайта сразу после оплаты',
    price_kgs: 950,
    duration_days: 180,
    features: [
      'Каталог вузов, проходные баллы, факультеты и специальности',
      'Анализ шансов, туры и рейтинги',
      'Tutor Community и информационные материалы',
      'Все платные функции без ограничений',
    ],
    sort_order: 1,
    is_active: true,
  },
